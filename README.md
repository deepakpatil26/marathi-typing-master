...
> _Engineered with React 19, TypeScript, Tailwind CSS v4, Express, and Google Gemini AI._
...
_(Note: If no API key is provided, the application automatically uses its built-in offline generation algorithms for all drills.)_
...
4. _(Optional)_ Under Environment Variables, add `GEMINI_API_KEY`.
